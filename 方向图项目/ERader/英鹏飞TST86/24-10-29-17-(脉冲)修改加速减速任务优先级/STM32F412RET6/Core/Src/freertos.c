...
void Motor_drive(void *argument)//电机加速启动
{
	...
	{    
//		osDelay(1);	
		status=osMessageQueueGet(Motor_driveQueueHandle,array_Motor_drive_receive,NULL,1);
		if(status==osOK)
		{	
				...
				if(flag_Zero_regression==1&&flag_Absolute_position==1)//之前回过零且接收到绝对位置
				{
					if(COROTATION)//正向移动
					{
						if(flag_Motor_deceleration_stops==0&&variable_Position_upload*10<variable_Target_position)
						{
							...
							else if(10000<variable_Running_speed_value&&variable_Running_speed_value<=20000&&variable_Position_upload*10>=variable_Target_position-900)
							{
								flag_Motor_deceleration_stops=1;					
							}
							else if(20000<variable_Running_speed_value&&variable_Running_speed_value<=30000&&variable_Position_upload*10>=variable_Target_position-1900)
							{
								flag_Motor_deceleration_stops=1;					
							}	
							else if(30000<variable_Running_speed_value&&variable_Running_speed_value<=40000&&variable_Position_upload*10>=variable_Target_position-3300)
							{
								flag_Motor_deceleration_stops=1;					
							}								
							else if(40000<variable_Running_speed_value&&variable_Running_speed_value<=50000&&variable_Position_upload*10>=variable_Target_position-5200)
							{
								flag_Motor_deceleration_stops=1;				
							}	
							else if(50000<variable_Running_speed_value&&variable_Running_speed_value<=60000&&variable_Position_upload*10>=variable_Target_position-7600)
							{
								flag_Motor_deceleration_stops=1;				
							}	
							else if(60000<variable_Running_speed_value&&variable_Running_speed_value<=70000&&variable_Position_upload*10>=variable_Target_position-10300)
							{
								flag_Motor_deceleration_stops=1;				
							}
							else if(70000<variable_Running_speed_value&&variable_Running_speed_value<=80000&&variable_Position_upload*10>=variable_Target_position-13200)
							{
								flag_Motor_deceleration_stops=1;				
							}
							else if(80000<variable_Running_speed_value&&variable_Running_speed_value<=90000&&variable_Position_upload*10>=variable_Target_position-16600)
							{
								flag_Motor_deceleration_stops=1;				
							}
							else if(90000<variable_Running_speed_value&&variable_Running_speed_value<=100000&&variable_Position_upload*10>=variable_Target_position-20200)
							{
								flag_Motor_deceleration_stops=1;				
							}													
						}
