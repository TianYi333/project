...
//		osDelay(1);	
		...
		{	
			...
			osDelay(1);	
			while(variable_Current_speed>number_v&&MOTION)
			{
				number_v++;
				...
				if(flag_Zero_regression==1&&flag_Absolute_position==1)//之前回过零且接收到绝对位置
				{
					if(COROTATION)//正向移动
					{
						if(flag_Motor_deceleration_stops==0&&variable_Position_upload*10<variable_Target_position)
						{
							...
							else if(10000<variable_Running_speed_value&&variable_Running_speed_value<=20000&&variable_Position_upload*10>=variable_Target_position-450)
							{
								flag_Motor_deceleration_stops=1;					
							}
							else if(20000<variable_Running_speed_value&&variable_Running_speed_value<=30000&&variable_Position_upload*10>=variable_Target_position-1000)
							{
								flag_Motor_deceleration_stops=1;					
							}	
							else if(30000<variable_Running_speed_value&&variable_Running_speed_value<=40000&&variable_Position_upload*10>=variable_Target_position-1740)
							{
								flag_Motor_deceleration_stops=1;					
							}								
							else if(40000<variable_Running_speed_value&&variable_Running_speed_value<=50000&&variable_Position_upload*10>=variable_Target_position-2560)
							{
								flag_Motor_deceleration_stops=1;				
							}	
							else if(50000<variable_Running_speed_value&&variable_Running_speed_value<=60000&&variable_Position_upload*10>=variable_Target_position-3710)
							{
								flag_Motor_deceleration_stops=1;				
							}	
							else if(60000<variable_Running_speed_value&&variable_Running_speed_value<=70000&&variable_Position_upload*10>=variable_Target_position-4960)
							{
								flag_Motor_deceleration_stops=1;				
							}
							else if(70000<variable_Running_speed_value&&variable_Running_speed_value<=80000&&variable_Position_upload*10>=variable_Target_position-6550)
							{
								flag_Motor_deceleration_stops=1;				
							}
							else if(80000<variable_Running_speed_value&&variable_Running_speed_value<=90000&&variable_Position_upload*10>=variable_Target_position-8350)
							{
								flag_Motor_deceleration_stops=1;				
							}
							else if(90000<variable_Running_speed_value&&variable_Running_speed_value<=100000&&variable_Position_upload*10>=variable_Target_position-10080)
							{
								flag_Motor_deceleration_stops=1;				
							}						
						}
						...
						else if(flag_Motor_deceleration_stops==0&&variable_Position_upload*10>=variable_Target_position*1.01)
						{
							flag_Motor_deceleration_stops=3;
							flag_Absolute_position=0;	
						}
					...
					else if(REVERSAL)//反向移动
					{
						...
						else if(flag_Motor_deceleration_stops==0&&variable_Position_upload*10<=variable_Target_position*0.99)
						{
							flag_Motor_deceleration_stops=3;
							flag_Absolute_position=0;	
						}
