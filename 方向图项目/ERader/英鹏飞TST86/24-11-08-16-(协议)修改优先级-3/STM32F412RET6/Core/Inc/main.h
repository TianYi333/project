...
#define MOTION HAL_GPIO_ReadPin(IN1_GPIO_Port,IN1_Pin)==GPIO_PIN_RESET//运动
#define CEASE  HAL_GPIO_ReadPin(IN1_GPIO_Port,IN1_Pin)==GPIO_PIN_SET//停止
...
extern uint8_t number_htim13;//TIM13中断计数
