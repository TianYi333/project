...
#define MOTION HAL_GPIO_ReadPin(IN0_GPIO_Port,IN0_Pin)==GPIO_PIN_SET//运动
#define CEASE  HAL_GPIO_ReadPin(IN0_GPIO_Port,IN0_Pin)==GPIO_PIN_RESET//停止
...
#define RS485_TX	HAL_GPIO_ReadPin(TIM8_CH1N_GPIO_Port,TIM8_CH1N_Pin)==GPIO_PIN_SET//PA8-发送
#define RS485_RX	HAL_GPIO_ReadPin(TIM8_CH1N_GPIO_Port,TIM8_CH1N_Pin)==GPIO_PIN_RESET//PA8-接收

#define DO_RS485_TX	HAL_GPIO_WritePin(SP3485_RS_GPIO_Port,SP3485_RS_Pin,GPIO_PIN_SET)//PA8-使发送
#define DO_RS485_RX	HAL_GPIO_WritePin(SP3485_RS_GPIO_Port,SP3485_RS_Pin,GPIO_PIN_RESET)//PA8-使接收
