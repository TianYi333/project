...
#define REACH HAL_GPIO_ReadPin(IN1_GPIO_Port,IN1_Pin)==GPIO_PIN_RESET//在原点
#define AWAY  HAL_GPIO_ReadPin(IN1_GPIO_Port,IN1_Pin)==GPIO_PIN_SET//不在原点

#define MOTION HAL_GPIO_ReadPin(TIM8_CH1N_GPIO_Port,TIM8_CH1N_Pin)==GPIO_PIN_SET//运动
#define CEASE  HAL_GPIO_ReadPin(TIM8_CH1N_GPIO_Port,TIM8_CH1N_Pin)==GPIO_PIN_RESET//停止

#define DO_MOTION HAL_GPIO_WritePin(TIM8_CH1N_GPIO_Port,TIM8_CH1N_Pin,GPIO_PIN_SET)//PA7-使运动
#define DO_CEASE  HAL_GPIO_WritePin(TIM8_CH1N_GPIO_Port,TIM8_CH1N_Pin,GPIO_PIN_RESET)//PA7-使停止
...
#define DO_RADAR_ON  HAL_GPIO_WritePin(TIM8_CH3_GPIO_Port,TIM8_CH3_Pin,GPIO_PIN_RESET)//PC8-使雷达上电
#define DO_RADAR_OFF HAL_GPIO_WritePin(TIM8_CH3_GPIO_Port,TIM8_CH3_Pin,GPIO_PIN_SET)//PC8-使雷达断电

#define RADAR_ON  HAL_GPIO_ReadPin(TIM8_CH3_GPIO_Port,TIM8_CH3_Pin)==GPIO_PIN_RESET//雷达上电
#define RADAR_OFF HAL_GPIO_ReadPin(TIM8_CH3_GPIO_Port,TIM8_CH3_Pin)==GPIO_PIN_SET//雷达断电
...
#define Subtraction 4000	//细分数(或输出多少个脉冲旋转一圈)

/***********************************************variable***********************************/
extern float variable_Position;//距0点位置,单位mm
extern uint32_t variable_Position_upload;//距0点距离上传值（单位0.001mm）
...
/***********************************************flag***************************************/
extern uint8_t flag_Extreme_position;//极限位置标志位
