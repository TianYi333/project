...
#define SP3485_RSB5_Pin GPIO_PIN_5
#define SP3485_RSB5_GPIO_Port GPIOB
...
extern uint8_t Hard_Trigger_flag;//硬触发启停标志位	
extern float speed_Record[SPEED_RECORD_NUM];

//typedef struct Hard_trigger
//{
//	uint8_t interval;		//硬触发时间间隔
//	uint8_t number;			//硬触发数
//	
//}Hard_trigger;
...
//{
//	uint8_t Hard_trigger_Group[2];
//	struct Hard_trigger Hard_trigger_parameters;
//};
